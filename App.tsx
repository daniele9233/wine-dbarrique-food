// App.tsx
// FIX DEFINITIVO - Configurazione Android-specific per tab bar
    ...
    <Tab.Navigator
      screenOptions={{
        tabBarStyle: Platform.select({
          ...
          android: {
            // ANDROID: NON absolute, altezza fissa ridotta
            backgroundColor: Colors.background,
            borderTopColor: Colors.border,
            borderTopWidth: 1,
            height: 60,
        ...
        // CRITICO PER ANDROID: nasconde tab bar quando tastiera aperta
